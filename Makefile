...
#Final
$(BIN)/main_can: $(OBJ)/main_can.o $(OBJ)/insertion_noeud.o $(OBJ)/insertion_donnee.o $(OBJ)/recherche_donnee.o $(OBJ)/gestion_liste.o $(OBJ)/gestion_voisin.o $(OBJ)/gestion_com.o $(OBJ)/gestion_routage.o
	$(CC) -o $@ $^ $(CFLAGS)
